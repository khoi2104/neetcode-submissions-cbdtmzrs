...
print(f"Initial Attributes: {whiskers.name} ({whiskers.species}) - Hunger: {str(whiskers.hunger)}, Energy: {str(whiskers.energy)}")
...
print(f"Modified Attributes: {whiskers.name} ({whiskers.species}) - Hunger: {str(whiskers.hunger)}, Energy: {str(whiskers.energy)}")